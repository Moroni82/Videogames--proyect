        ...
        <>
          ...
          <form onSubmit={handleName} className="formulario">
            <div className="filter">
              <select onChange={handleFilter} defaultValue="" className="slct">
                <option value="" hidden="hidden" className="filterby">Filter by</option>
                <optgroup label="Genres">
                  {genres.map((genre) => (
                    <option key={`${genre.id}${genre.name}`} value={genre.name}> {genre.name} </option>
                  ))}
                </optgroup>
              </select>
            </div>
            ...
            <div className="form__group field">
              <input
                ...
                id="name"
              />
              <label htmlFor="name" className="form__label">Search videogame</label>
            </div>
              ...
              <div className="diver">
                {!games.length ? (
                  ...
                  games
                    ...
                    .map((game) => (
                      <figure key={game.id} className="image-block">
          ...
          <div className="paginate">
            ...
            <button
              onClick={nextPage}
              className={
                pageNumber === maxPages - 1 || games.length === 0
                  ? "Bttn-No-visible"
                  : "Bttn-visible"
              }
            >
